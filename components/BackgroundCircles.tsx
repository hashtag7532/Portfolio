...
function BackgroundCircles({}: Props) {
  return (
    ...
    transition={{
        ...
        <div className='absolute border-[3px] rounded-full opacity-20 border-[#ff0000] h-[650px] w-[650px] mt-52 animate-pulse'/>
        <div className='absolute border border-[#fff] rounded-full h-[800px] w-[800px] mt-52 animate-ping'/>
    </motion.div>
  )
}
